        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed max-w-md mb-8">
              The simple, powerful todo app that helps you stay focused and get things done. Organize your life, one task at a time.
            </p>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="group w-10 h-10 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:border-primary-500 hover:text-primary-600 dark:hover:text-primary-400 hover:shadow-lg hover:shadow-primary-500/20 transition-all duration-300 hover:-translate-y-1"
                aria-label="Twitter"
              >
            ...
            <ul className="space-y-4">
              {footerLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="group inline-flex items-center text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-all duration-200"
                  >
